...
class CommandFactoryTest extends WithServerMock_TestCase
{
     ...
     */
    public function testCreateCommand_UnknownCommand_ThrowsException()
    {
        $this->commandFactory->createCommand('UNKNOWN');
    }
    ...
    {
        $buryCommand = $this->commandFactory->createCommand(Command::COMMAND_BURY, [self::TEST_ID]);
        $expected = join(' ', [
    ...
    public function testBuryCommand_GetCommandLine_withArgs_usesArgs()
    {
        ...
        $buryCommand = $this->commandFactory->createCommand(Command::COMMAND_BURY, [self::TEST_ID, $priority]);
    ...
    {
        $this->commandFactory
            ->createCommand(Command::COMMAND_BURY, [self::TEST_ID])
    ...
    public function testDeleteCommand_GetCommandLine_correctFormat()
    {
        ...
        $deleteCommand = $this->commandFactory->createCommand(Command::COMMAND_DELETE, [self::TEST_ID]);
    ...
    {
        $this->commandFactory
            ->createCommand(Command::COMMAND_DELETE, [self::TEST_ID])
    ...
    public function testIgnoreCommand_GetCommandLine_matchesExpectedFormat()
    {
        ...
        $commandLine = $this->commandFactory
            ->createCommand(Command::COMMAND_IGNORE, [$tubeName])
            ->getCommandLine();
    ...
    public function testIgnoreCommand_ParseResponse_returnsResponse()
    {
        ...
        $ignoreCommand = $this->commandFactory->createCommand(Command::COMMAND_IGNORE, [Beanie::DEFAULT_TUBE]);
    ...
    public function testKickCommand_GetCommandLine_noArgs_usesDefaults()
    {
        ...
        $command = $this->commandFactory->createCommand(Command::COMMAND_KICK);
    ...
    public function testKickCommand_GetCommandLine_withArgs_usesArgs()
    {
        ...
        $command = $this->commandFactory->createCommand(Command::COMMAND_KICK, [$maxToKick]);
    ...
    public function testKickJobCommand_GetCommandLine_correctFormat()
    {
        ...
        $kickCommand = $this->commandFactory->createCommand(Command::COMMAND_KICK_JOB, [self::TEST_ID]);
    ...
    {
        $this->commandFactory
            ->createCommand(Command::COMMAND_KICK_JOB, [self::TEST_ID])
            ->parseResponse('what', $this->_getServerMock());
    }
    ...
    public function testListTubesCommand_GetCommandLine_correctFormat()
    {
        $this->assertEquals(
            ...
            $this->commandFactory->createCommand(Command::COMMAND_LIST_TUBES)->getCommandLine()
        );
    }
    ...
    public function testListTubesWatchedCommand_GetCommandLine_correctFormat()
    {
        $this->assertEquals(
            ...
            $this->commandFactory->createCommand(Command::COMMAND_LIST_TUBES_WATCHED)->getCommandLine()
        );
    }
    ...
    public function testListTubeUsedCommand_GetCommandLine_correctCommandLine()
    {
        $this->assertEquals(
            ...
            $this->commandFactory->createCommand(Command::COMMAND_LIST_TUBE_USED)->getCommandLine()
        );
    }
    ...
    public function testListTubeUsedCommand_ParseResponse_returnsResponse_withTubeUsed()
    {
        ...
        $command = $this->commandFactory->createCommand(Command::COMMAND_LIST_TUBE_USED);
        $response = $command->parseResponse($responseLine, $this->_getServerMock());
    ...
    {
        $this->commandFactory->createCommand(Command::COMMAND_PAUSE_TUBE, [$tubeName]);
    }
    ...
    {
        $command = $this->commandFactory->createCommand(Command::COMMAND_PAUSE_TUBE, [$tubeName]);
    ...
    public function testPauseTubeCommand_GetCommandLine_args_usesArgs()
    {
        ...
        $command = $this->commandFactory->createCommand(Command::COMMAND_PAUSE_TUBE, [self::TEST_TUBE, $delay]);
    ...
    {
        $this->commandFactory
            ->createCommand(Command::COMMAND_PAUSE_TUBE, [self::TEST_TUBE])
            ->parseResponse(Response::FAILURE_NOT_FOUND, $this->_getServerMock());
    }
    ...
    public function testPeekCommand_ParseResponse_notFoundFailure_throwsNotFoundException()
    {
        ...
        $command = $this->commandFactory->createCommand(Command::COMMAND_PEEK, [self::TEST_TUBE]);
    ...
    public function testPeekCommand_ParseResponse_foundResponse_returnsResponse()
    {
        ...
        /** @var \PHPUnit_Framework_MockObject_MockObject|\Beanie\Command\Command $command */
        $command = $this->commandFactory->createCommand(Command::COMMAND_PEEK, [self::TEST_ID]);
    ...
    public function testPeekCommand_GetCommandLine_correctFormat()
    {
        ...
        $this->assertEquals(
            $expected,
            $this->commandFactory->createCommand(Command::COMMAND_PEEK, [self::TEST_ID])->getCommandLine()
        );
    }
    ...
    public function testPeekBuriedCommand_GetCommandLine_correctFormat()
    {
        $this->assertEquals(
            ...
            $this->commandFactory->createCommand(Command::COMMAND_PEEK_BURIED)->getCommandLine()
        );
    }
    ...
    public function testPeekDelayedCommand_GetCommandLine_correctFormat()
    {
        $this->assertEquals(
            ...
            $this->commandFactory->createCommand(Command::COMMAND_PEEK_DELAYED)->getCommandLine()
        );
    }
    ...
    public function testPeekReadyCommand_GetCommandLine_correctFormat()
    {
        $this->assertEquals(
            ...
            $this->commandFactory->createCommand(Command::COMMAND_PEEK_READY)->getCommandLine()
        );
    }
    ...
    {
        $putCommand = $this->commandFactory->createCommand(Command::COMMAND_PUT, [self::TEST_DATA]);
    ...
    public function testPutCommand_GetCommandLine_args_usesArgs()
    {
        ...
        $putCommand = $this->commandFactory
            ->createCommand(Command::COMMAND_PUT, [self::TEST_DATA, $priority, $delay, $timeToRun]);
    ...
    public function testQuitCommand_GetCommandLine_correctCommand()
    {
        $this->assertEquals(
            ...
            $this->commandFactory->createCommand(Command::COMMAND_QUIT)->getCommandLine()
        );
    }
    ...
    {
        $this->commandFactory
            ->createCommand(Command::COMMAND_QUIT)
            ->parseResponse('something', $this->_getServerMock());
    }
    ...
    public function testReleaseCommand_GetCommandLine_noArgs_defaultValues()
    {
        ...
        $releaseCommand = $this->commandFactory->createCommand(Command::COMMAND_RELEASE, [self::TEST_ID]);
    ...
    public function testReleaseCommand_GetCommandLine_args_usesArgs()
    {
        ...
        $releaseCommand =$this->commandFactory
            ->createCommand(Command::COMMAND_RELEASE, [self::TEST_ID, $priority, $delay]);
    ...
    public function testReserveCommand_GetCommandLine_noArgs_usesDefaults()
    {
        ...
        $this->assertEquals(
            $expected,
            $this->commandFactory->createCommand(Command::COMMAND_RESERVE)->getCommandLine()
        );
    }
    ...
    {
        $this->commandFactory
            ->createCommand(Command::COMMAND_RESERVE)
    ...
    public function testReserveCommand_ParseResponse_readsDataFromServer_returnsResponse()
    {
        ...
        $command = $this->commandFactory->createCommand(Command::COMMAND_RESERVE);
    ...
    public function testReserveCommandWithTimeout_GetCommandLine_noArgs_usesDefaults()
    {
        ...
        $this->assertEquals(
            $expected,
            $this->commandFactory
                ->createCommand(Command::COMMAND_RESERVE_WITH_TIMEOUT, [self::TEST_TIMEOUT])
                ->getCommandLine()
        );
    }
    ...
    public function testReserveCommandWithTimeout_ParseResponse_readsDataFromServer_returnsResponse()
    {
        ...
        $command = $this->commandFactory->createCommand(Command::COMMAND_RESERVE_WITH_TIMEOUT, [self::TEST_TIMEOUT]);
    ...
    public function testStatsCommand_GetCommandLine_correctFormat()
    {
        $this->assertEquals(
            ...
            $this->commandFactory->createCommand(Command::COMMAND_STATS)->getCommandLine()
        );
    }
    ...
    public function testStatsJobCommand_GetCommandLine_correctFormat()
    {
        ...
        $command = $this->commandFactory->createCommand(Command::COMMAND_STATS_JOB, [self::TEST_ID]);
    ...
    {
        $this->commandFactory
            ->createCommand(Command::COMMAND_STATS_JOB, [self::TEST_ID])
            ->parseResponse(Response::FAILURE_NOT_FOUND, $this->_getServerMock());
    }
    ...
    {
        $this->commandFactory->createCommand(Command::COMMAND_STATS_TUBE, [$tubeName]);
    }
    ...
    {
        $command = $this->commandFactory->createCommand(Command::COMMAND_STATS_TUBE, [$tubeName]);
    ...
    public function testStatsTubeCommand_GetCommandLine_correctFormat()
    {
        ...
        $command = $this->commandFactory->createCommand(Command::COMMAND_STATS_TUBE, [self::TEST_TUBE]);
    ...
    {
        $this->commandFactory
            ->createCommand(Command::COMMAND_STATS_TUBE, [self::TEST_TUBE])
            ->parseResponse(Response::FAILURE_NOT_FOUND, $this->_getServerMock());
    }
    ...
    public function testTouchCommand_GetCommandLine_correctFormat()
    {
        ...
        $touchCommand = $this->commandFactory->createCommand(Command::COMMAND_TOUCH, [self::TEST_ID]);
    ...
    {
        $this->commandFactory
            ->createCommand(Command::COMMAND_TOUCH, [self::TEST_ID])
            ->parseResponse('what', $this->_getServerMock());
    }
    ...
    public function testUseCommand_GetCommandLine_matchesExpectedFormat()
    {
        ...
        $commandLine = $this->commandFactory
            ->createCommand(Command::COMMAND_USE, [$tubeName])
            ->getCommandLine();
    ...
    public function testUseCommand_ParseResponse_returnsResponse()
    {
        ...
        $useCommand = $this->commandFactory->createCommand(Command::COMMAND_USE, [Beanie::DEFAULT_TUBE]);
    ...
    public function testWatchCommand_GetCommandLine_matchesExpectedFormat()
    {
        ...
        $commandLine = $this->commandFactory
            ->createCommand(Command::COMMAND_WATCH, [$tubeName])
            ->getCommandLine();
    ...
    public function testWatchCommand_ParseResponse_returnsResponse()
    {
        ...
        $watchCommand = $this->commandFactory->createCommand(Command::COMMAND_WATCH, [Beanie::DEFAULT_TUBE]);
